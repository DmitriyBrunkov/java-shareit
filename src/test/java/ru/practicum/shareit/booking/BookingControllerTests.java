...
public class BookingControllerTests {
    ...
    private BookingShortDto bookingShortDto = BookingMapper.toBookingShortDto(booking);
    ...
    @Test
    void bookingControllerThrowsBookingIntervalInvalidExceptionTest() throws Exception {
        booking.setEnd(LocalDateTime.now().withNano(0).minusMonths(1));
        ...
        mvc.perform(post("/bookings")
                        ...
                        .content(mapper.writeValueAsString(bookingShortDto)))
                .andExpect(status().is4xxClientError())
                .andExpect(jsonPath("$.error", is("Interval: " + bookingShortDto.getStart() + " - " +
