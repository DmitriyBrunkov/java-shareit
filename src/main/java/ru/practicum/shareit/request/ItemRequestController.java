...
public class ItemRequestController {
    ...
    @PostMapping
    public ItemRequestDto add(@RequestHeader("X-Sharer-User-Id") Long requestorId, @RequestBody @Validated ItemRequestDto itemRequestDto) throws
    ...
    @GetMapping("/all")
    public List<ItemRequestWithItemDto> getAll(@RequestHeader("X-Sharer-User-Id") Long userId, @RequestParam(defaultValue = "0") int from, @RequestParam(defaultValue = "20") int size) throws
            IllegalPagingArgumentException {
